...
//
//go:generate mockgen -destination=../../../../mocks/mock_BaseStorageManager.go -package=mocks github.com/erupshis/effective_mobile/internal/server/storage/managers BaseStorageManager
